...
This package is a wrapper around the [VoteSmart](https://justfacts.votesmart.org/) [API](http://api.votesmart.org/docs/) provided by your friendly neighborhood progressive tech organization, `r emo::ji("star2")` [*Deck Technologies*](https://www.deck.tools/) `r emo::ji("star2")`. Feel free to use this package in any way you like.
