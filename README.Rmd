...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/decktools/votesmart.svg?token=G3ZELzKsL1syAMRqs54K&branch=master)](https://travis-ci.com/decktools/votesmart) 
...
A key feature of VoteSmart's data is the ratings that Special Interest Groups (SIGs) give to candidates on various issues.
